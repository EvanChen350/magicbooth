    ...
    <section className='relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900'>
      <div className='mx-auto max-w-6xl px-4 sm:px-6'>
        <div className='py-12 md:py-20'>
            ...
            <div className='text-center'>
              <div className='relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,theme(colors.blue.500),transparent)]'>
                ...
                <div className='pointer-events-none' aria-hidden='true'>
                  ...
                  />
                  <div>
                    <div className='flex justify-center items-center w-48 h-48 p-4 bg-white rounded-md absolute -left-28 top-12 z-10 animate-[float_3s_linear_infinite_both] opacity-80 transition-opacity'>
                      <div className='w-full h-full bg-red-500 rounded-md'>
                        <Image src={WaitInLine} fill alt='Wait In Line' />
                      </div>
                    </div>

                    <div
                      className='flex justify-center items-center w-48 h-48 p-4 bg-white rounded-md absolute left-72 top-7 z-10 animate-[float_4s_ease-in-out_infinite_1s_both] opacity-80 transition-opacity
                    '
                    >
                      <div className='w-full h-full bg-red-500 rounded-md'>
                        <Image src={WaitInLine} fill alt='Wait In Line' />
                    ...
                    <div className='flex justify-center items-center w-48 h-48 p-4 bg-white rounded-md absolute -left-20 -bottom-32 z-10 animate-[float_4s_ease-in-out_infinite_2s_both] opacity-80 transition-opacity'>
                      <div className='w-full h-full bg-red-500 rounded-md'>
                        <Image src={WaitInLine} fill alt='Wait In Line' />
                      </div>
                    </div>

                    <div className='flex justify-center items-center w-48 h-48 p-4 bg-white rounded-md absolute -bottom-40 left-64 z-10 animate-[float_4s_ease-in-out_infinite_3s_both] opacity-80 transition-opacity'>
                      <div className='w-full h-full bg-red-500 rounded-md'>
                        <Image src={WaitInLine} fill alt='Wait In Line' />
                      </div>
                    </div>
          ...
          {/* Grid */}
          {/* //! remove `lg:grid-cols-2` if not needed */}
          <div className='grid overflow-hidden sm:grid-cols-2 lg:grid-cols-2 mt-20 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10'>
            <article>
            ...
            <article>
              <h3 className='mb-2 flex items-center space-x-2 font-medium text-gray-200'>
                ...
                <span>Confidential or Sensitive Work</span>
              </h3>
              <p className='text-[15px] text-gray-400'>
                The booth was designed with adjustable opaque walls or partitions to
                prevent visual and auditory intrusion and also offers secure internet
                access.
              </p>
            </article>
            <article>
              ...
              <p className='text-[15px] text-gray-400'>
                This booth is equipped with a stable internet connection and soundproofing
                to ensure clear audio during video calls.
              </p>
            </article>
            <article>
              <h3 className='mb-2 flex items-center space-x-2 font-medium text-gray-200'>
              ...
              <p className='text-[15px] text-gray-400'>
                Offer round-the-clock access to the booth with smart booking system,
                especially for those who need to work with international time zones.
              </p>
            </article>
            <article>
              <h3 className='mb-2 flex items-center space-x-2 font-medium text-gray-200'>
